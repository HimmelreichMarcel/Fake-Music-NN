...
class MIDI_Converter():
    ...
    def dataToMidi(self,notes,filename):
        '''
        Converts Notes to Midi Stream (Music21 Object)
        '''
        #Create Midi Stream (Music21  Object)
        midistream = music21.stream.Stream()
        
        for note in notes:
            #Add Notes to Stream
            midistream.append(music21.note.Note(note))
        
        #Plote Notes
        midistream.show()
        
        #Save Stream as Midi File
